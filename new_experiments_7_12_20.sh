...
# Fixed window size
conda activate experiments && python train.py -W 5 -A lc -T 1 -alpha 1 --beta 0 -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 1 -alpha 1 --beta 0.01 -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 2.5 -alpha 1 --beta 0.01 -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 1 -alpha 1 --beta 0.1 -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 2.5 -alpha 1 --beta 0.1 -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 1 -alpha 1 --beta '-0.01' -R 10000 -I 0.01
conda activate experiments && python train.py -W 5 -A lc -T 2.5 -alpha 1 --beta '-0.01' -R 10000 -I 0.01
